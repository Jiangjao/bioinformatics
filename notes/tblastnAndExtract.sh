...
# Example usage:
# DIR=/fafu/jiangxiaojiao/data/horizontalTransfer/genomes/fungi/Yarrowia.lipolytica DATABASE=Yarrowia.lipolytica_GCF_000002525.2_ASM252v1_genomic.fna QUERY=L1_ORFp.fasta RESULTSDIR=/fafu/jiangxiaojiao/data/horizontalTransfer/results/L1/tblastned bash tblastnAndExtract.q
...
tblastn -db "$DIR/$DATABASE" -num_threads 2 -query /fafu/jiangxiaojiao/data/horizontalTransfer/queries/"$QUERY" -out "$DATABASE"_"$QUERY".out -outfmt "6 qseqid sseqid bitscore qcovs evalue pident length mismatch gapopen qstart qend qseq sstart send sseq" -evalue 1e-5 -show_gis \
2> "$DATABASE"_"$QUERY".log

	
# Yarrowia.lipolytica_GCF_000002525.2_ASM252v1_genomic.fna_L1_ORFp.fasta.out:
